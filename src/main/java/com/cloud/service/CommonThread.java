...
public class CommonThread extends Thread {
    ...
    public CommonThread(String sendWay, ThreadStateFlag threadStateFlag,
        ...
        this.baseQuerySql = PropertiesReader.getProp("baseQuerySql" + sendWay);
        this.baseUpdateSql = PropertiesReader.getProp("baseUpdateSql" + sendWay);
    }
